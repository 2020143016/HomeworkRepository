...
# 그래프 생성
x = TIG_GDP_correlation[columnName]
y = TIG_GDP_correlation['absCorrelation']
dif,ax = plt.subplots()
ax.scatter(x,y,s = TIG_GDP_correlation[columnName2]/80)
ax.set_xlabel(columnName+'size:'+columnName2)
ax.set_ylabel('absCorrelation')
plt.show()
